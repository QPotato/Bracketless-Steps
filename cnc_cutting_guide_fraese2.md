# CNC Cutting Guide — CNC-Fraese-2 (das-labor)

This guide is for cutting the polycarbonate panels on CNC-Fraese-2 at das-labor.
It is based on the machine wiki page and the lab workflow guide.
For a machine-independent version see `cnc_cutting_guide.md`.
